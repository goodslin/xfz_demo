...
def add_event(request):
    ...
    if result:
        return JsonResponse({'status': 10022, 'message': 'event id already exist'})
    ...
    try:
        ...
        return JsonResponse({'status': 10024, 'messate': error})
...
def get_event_list(request):
    ...
    if eid != '':
        ...
        try:
            ...
            return JsonResponse({'status': 10022, 'message': 'query result id empty'})
        else:
...
def get_guest_list(request):
    ...
    if eid != '' and phone == '':
        ...
        if results:
            ...
            return JsonResponse({'status': 200, 'message': 'query result is empyt'})
